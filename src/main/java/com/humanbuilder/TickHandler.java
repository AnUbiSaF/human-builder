 ...
 *
 *   1. {@link BuildExecutor#tick()} — стейт-машина принимает решения
 *   2. {@link MovementController#tick()} — обновляет клавиши движения
 *   3. {@link CameraSmoother#tick()} — интерполирует камеру
 *
